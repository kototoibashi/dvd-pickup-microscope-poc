...
<p align="center">
  <img src="HTB127OhJFzqK1RjSZSgq6ApAVXaN.jpg" alt="Example of FFC conversion adapter available on AliExpress" width="50%">
</p>

( [Example of FFC conversion adapter available on AliExpress.](https://www.aliexpress.com/item/32982483720.html) I have not verified if this is fit. The number of pins does not match, but if FFC is cut to 26-pin width, it may be usable. )  
