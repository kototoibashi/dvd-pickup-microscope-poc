...
( [Example of FFC conversion adapter available on AliExpress.](https://www.aliexpress.com/item/32982483720.html) Not sure if this will fit. The pin count doesn't match, but if you cut the FFC to 26 pins, it could be used. )  
